<h2><a href="https://www.geeksforgeeks.org/problems/decode-the-pattern1138/1?page=3&company=Zoho&sortBy=submissions">Look and Say Pattern</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an integer n.&nbsp;Return&nbsp;the nth row of the following look-and-say pattern.<br>
1<br>
11<br>
21<br>
1211<br>
